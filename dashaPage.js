      ...
      <div class="card shadow-lg" style="background:#1a1a1a;border:1px solid rgba(212,175,55,0.4);border-radius:16px;">
        <div class="card-body p-4">
          <div class="row justify-content-center mb-4">
            <div class="col-md-5">
              <label class="text-gold mb-1">วันเกิด (พ.ศ.)</label>
              <div class="input-group">
                <input type="text" id="dashaBirthDate" class="form-control bg-dark text-white border-gold"
                  placeholder="เช่น 15/3/2510" value="${dispDate}"
