...
function renderAdminDashboard() {
    ...
    const html = `
        <div class="admin-dashboard">
            ...
            <div class="dashboard-tools" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-bottom: 30px;">
                <button class="btn btn-gold shadow" onclick="openContentGeneratorModal()" style="font-size: 1.1rem; padding: 20px; border-radius: 12px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 10px; border: none; height: 100%;">
                    <i class="fas fa-magic" style="font-size: 2.5rem;"></i> 
                    <span>สร้างคอนเทนต์<br>รายวัน</span>
                </button>
                <button class="btn btn-primary shadow" onclick="openVIPReportModal()" style="font-size: 1.1rem; padding: 20px; border-radius: 12px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 10px; background: linear-gradient(135deg, #007bff, #0056b3); color: white; border: none; height: 100%;">
                    <i class="fas fa-file-pdf" style="font-size: 2.5rem;"></i> 
                    <span>สร้างรายงาน<br>PDF (VIP)</span>
                </button>
                <div style="border: 2px dashed #d1d1d1; border-radius: 12px; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #a1a1a1; padding: 20px; height: 100%; background: #f8f9fa;">
                    <i class="fas fa-plus" style="font-size: 2.5rem; margin-bottom: 10px;"></i>
                    <span>(เพิ่มฟีเจอร์ใหม่)</span>
                </div>
            </div>
